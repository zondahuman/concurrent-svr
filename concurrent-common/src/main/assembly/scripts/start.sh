...
nohup java -server -Xms4g -Xmx4g -Xss2m -XX:PermSize=512m -XX:MaxPermSize=512m -XX:NewRatio=2  -XX:+UseGCOverheadLimit -XX:-UseParallelGC -XX:ParallelGCThreads=24 -Dio.netty.leakDetection.level=advanced -Dlog4j2.worker=$logFile   com.abin.lee.concurrent.common.hook.WorkerServer >> $logFile  2>&1 &